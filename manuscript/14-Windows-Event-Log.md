...
In contrast, an application that runs as a Windows Service is _expected_ to write to the Windows Event Log when it starts, when it quits and when it encounters problems, and it might add even more information. There are few exceptions.
